...
@end
@implementation UIControl (YomoTouch)
...
- (void)cjr_sendAction:(SEL)action to:(id)target forEvent:(UIEvent *)event{
    ...
    self.cjr_acceptEventInterval =self.cjr_acceptEventInterval ==0 ?defaultInterval:self.cjr_acceptEventInterval;
